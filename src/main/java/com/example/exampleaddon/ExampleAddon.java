...
public final class ExampleAddon extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (skript == null || !skript.isEnabled()) {
            ...
            return;
        } else if (Skript.getVersion().compareTo(new Version(2, 7, 0)) < 0) { // You may remove this if you want.
        ...
        int pluginId = 99999; // Input your bStats plugin ID here, if you do not wish to use bStats, you may remove this section.
        ...
        try {
            addon.loadClasses("com.example.ExampleAddon");
        } catch (IOException error) {
            error.printStackTrace();
            manager.disablePlugin(this);
            return;
        }
        getLogger().info("Successfully loaded ExampleAddon.");
    }
